...
class State {
  public:
    ...
    const std::map<Symbol, std::vector<std::string>> GetTransitions(Symbol) const;
    ...
    // void SetInitial(void); // define el estado como inicial (se realiza a la hora de crear el nfa)
